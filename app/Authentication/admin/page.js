...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#0B1220]">
      {/* Left brand panel */}
      <div className="hidden lg:flex lg:w-[42%] relative overflow-hidden bg-[#314E5A]">
        <div
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-md bg-[#314E5A] flex items-center justify-center">
          ...
          <div>
            <div className="h-px w-12 bg-[#314E5A] mb-6" />
      ...
      <div className="flex-1 flex items-center justify-center px-6 sm:px-10 bg-[#F8F9FB]">
        <div className="w-full max-w-[380px]">
          ...
          <div className="flex lg:hidden items-center gap-2.5 mb-10">
            <div className="h-9 w-9 rounded-md bg-[#314E5A] flex items-center justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-11 rounded-md border border-slate-200 bg-white px-3.5 text-sm text-[#0F172A] placeholder:text-slate-400 outline-none transition-colors focus:border-[#314E5A] focus:ring-2 focus:ring-[#314E5A]/15"
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a
                  href="#"
                  className="text-[13px] text-[#314E5A] hover:text-[#22363f] font-medium"
                >
                  Forgot password?
                </a>
              </div>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full h-11 rounded-md border border-slate-200 bg-white px-3.5 pr-10 text-sm text-[#0F172A] placeholder:text-slate-400 outline-none transition-colors focus:border-[#314E5A] focus:ring-2 focus:ring-[#2563EB]/15"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 rounded-md bg-[#314E5A] text-white text-sm font-medium tracking-tight hover:bg-[#23363e] active:bg-[#102128] transition-colors disabled:opacity-70 flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
                <>
